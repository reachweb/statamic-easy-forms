...
test('email template renders with special characters in values', function () {
    ...
    expect($rendered)
        ->toContain('Company')
        ->toContain('Smith &amp; Sons'); // HTML entities are properly escaped
});
...
test('email template renders group fields with proper display names', function () {
    $form = createTestForm('group_test');
    ...
    $data = [
        'fields' => [
            [
                ...
                'config' => [
                    'fields' => [
                        ['handle' => 'start_date', 'field' => ['display' => 'Start Date', 'type' => 'text']],
                        ['handle' => 'end_date', 'field' => ['display' => 'End Date', 'type' => 'text']],
                    ],
                ],
                'value' => [
...
test('email template skips empty nested fields in groups', function () {
    $form = createTestForm('group_empty_test');
    ...
    $data = [
        'fields' => [
            [
                ...
                'config' => [
                    'fields' => [
                        ['handle' => 'street', 'field' => ['display' => 'Street', 'type' => 'text']],
                        ['handle' => 'apt', 'field' => ['display' => 'Apt #', 'type' => 'text']],
                        ['handle' => 'city', 'field' => ['display' => 'City', 'type' => 'text']],
                    ],
                ],
                'value' => [
                    'street' => '123 Main St',
...
test('email template handles group with array values in nested fields', function () {
    $form = createTestForm('group_array_test');
    ...
    $data = [
        'fields' => [
            [
                ...
                'config' => [
                    'fields' => [
                        ['handle' => 'colors', 'field' => ['display' => 'Favorite Colors', 'type' => 'checkboxes']],
                        ['handle' => 'size', 'field' => ['display' => 'Size', 'type' => 'select']],
                    ],
                ],
                'value' => [
...
test('email template does not render group with all empty nested values', function () {
    $form = createTestForm('group_all_empty_test');
            ...
            [
                ...
                'config' => [
                    'fields' => [
                        ...
                        ['handle' => 'field2', 'field' => ['display' => 'Field 2', 'type' => 'text']],
                    ],
                ],
                'value' => [
                    'field1' => '',
    ...
    expect($rendered)
        ->not->toContain('Empty Group')
        ->not->toContain('Field 1')
        ->not->toContain('Field 2')
        ->toContain('Regular Field')
        ->toContain('Has Value');
});

test('email template renders group field header with uppercase styling', function () {
    $form = createTestForm('group_styling_test');
    ...
    $data = [
        'fields' => [
            [
                ...
                'config' => [
                    'fields' => [
                        ['handle' => 'email', 'field' => ['display' => 'Email', 'type' => 'text']],
                    ],
                ],
                'value' => [
